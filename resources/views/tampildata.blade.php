                    ...
                    <div class="card-body ">
                        <form action="/updatedata/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="pengarang" class="form-control" id="pengarang" name="pengarang" value="{{ $data->pengarang }}">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" aria-label="Default select example" id="genre" name="genre" value="{{ $data->genre }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="harga" class="form-control" id="harga" name="harga" value="{{ $data->harga }}">
                            </div>
                            <div class="mb-3">
                                <label for="des" class="form-label">Deskripsi</label>
                                <input type="des" class="form-control" id="des" name="des" value="{{ $data->des }}">
                            </div>
                            <div class="mb-3">
                                <label for="cover" class="form-label">Cover</label>
                                <input type="file" class="form-control" id="cover" name="cover" value="{{ $data->cover }}">
                            </div>
